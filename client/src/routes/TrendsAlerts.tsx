...
import { crimeHeadSlices, totalCasesInView } from "../data/mapMock";
import {
  riskZones,
  trendAlerts,
  trendAxisLabels,
    ...
    <>
      ...
      <div className="ta-mid">
        <Panel title="Trend Overview" note="· current vs last period">
          ...
          <LineChart current={trendCurrent} previous={trendPrevious} labels={trendAxisLabels} />
        </Panel>

        <Panel title="Crime Head Distribution">
          <div className="ta-dist">
            <Donut slices={crimeHeadSlices} centerValue={totalCasesInView} centerLabel="Total Cases" />
...
function TrendTile({ kpi }: { kpi: TrendKpi }) {
